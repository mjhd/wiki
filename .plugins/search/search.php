...
<title>Any where In Files || AnyWhereInFiles.php</title>
    <style>
        ...
        #searchForum { display: inline-block }
        #searchForum > table { position: relative; padding-bottom: 65px; }
        body {
        ...
        .me{font-size:11px; font-family:arial;color:#333;display:inline-block;padding-top:20px;border-top:solid 1px #888;}
    ...
    <script>
        ...
        function submit_form() {
            document.getElementById('directory').value = document.getElementById('directory').value + document.getElementById('directory_view').value.trim()
    ...
    <table>
        <tbody>
            ...
            <tr>
                ...
                <td>/wiki/<input id="directory_view" type="text" name="" placeholder="directory_name" /></td>
            </tr>
            ...
            <tr>
                <td><input type="button" id="submit_button" onclick="submit_form();" value="Search the string" /></td>
            </tr>
        </tbody>
    </table>
</form>
